...
- Khi làm việc trên module cụ thể: Đọc trực tiếp skill của module đó (vd: `bom-core`, `vinfast-parts-stock`, `vinfast-parts-dashboard` tại `.agents/skills/modules/<module-name>/SKILL.md`).
