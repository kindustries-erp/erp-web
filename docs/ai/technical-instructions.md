...
### 2.3 Lessons learned bắt buộc khi có issue
...
### 3.5 Folder structure theo pattern TienMat
...
## 6) Output contract khi agent báo hoàn tất
Agent phải báo rõ:
1. Danh sách file đã đổi
2. Checklist tasks đã tick xong
3. Nếu có issue đã gặp -> link/entry lessons learned
4. Kết quả validation (`tsc`, smoke check)

## 7) Templates và tài liệu liên quan
