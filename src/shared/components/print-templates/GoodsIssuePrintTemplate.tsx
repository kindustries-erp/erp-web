...
export interface GoodsIssuePrintData {
  issueNo: string;
  issueDate: string;
  customerName?: string;
  remarks?: string;
...
interface Props {
  ...
  data: GoodsIssuePrintData | null;
}

export const GoodsIssuePrintTemplate = React.forwardRef<HTMLDivElement, Props>(
      ...
      >
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="text-center font-bold">
            <div className="text-lg">Mẫu số 02 - VT</div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-black p-1 text-center font-bold">
                {data.lines
                  .reduce((sum, l) => sum + (Number(l.qtyIssued) || 0), 0)
              ...
              <td className="border border-black p-1 text-right font-bold">
                {data.lines
                  .reduce(
                    (sum, l) =>
                      sum +
                      (Number(l.qtyIssued) || 0) * (Number(l.unitCost) || 0),
                    0,
                  )
                  .toLocaleString("vi-VN")}
              </td>
        ...
        <div className="flex justify-between text-center pb-20">
          ...
          <div className="flex-1">
            ...
            <div className="italic text-sm">(Hoặc bộ phận có nhu cầu xuất)</div>
            <div className="italic text-sm">(Ký, họ tên)</div>
          </div>
          <div className="flex-1">
...
GoodsIssuePrintTemplate.displayName = "GoodsIssuePrintTemplate";
