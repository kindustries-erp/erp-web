export const moduleConfigVi = {
  ...
  catCode: "Mã danh mục",
  catName: "Tên danh mục (Tiếng Việt)",
  catNameEn: "Tên danh mục (Tiếng Anh)",
  ...
  attrName: "Tên hiển thị (Tiếng Việt)",
  attrNameEn: "Tên hiển thị (Tiếng Anh)",
  attrFieldType: "Kiểu dữ liệu",
  attrConstraint: "Ràng buộc dữ liệu",
  domain: "Khối nghiệp vụ",
  targetModule: "Phân hệ",
  origin: "Nguồn gốc",
  isRequired: "Bắt buộc",
  ...
  customAttrTooltip: "Thuộc tính tùy chỉnh do doanh nghiệp tự tạo",
  used: "đang dùng",
  ...
  optionLabelVi: "Tên tùy chọn (Tiếng Việt)",
  optionLabelEn: "Tên tùy chọn (Tiếng Anh)",
  attrNameMultilingual: "Tên hiển thị đa ngôn ngữ",
  catNameMultilingual: "Tên danh mục đa ngôn ngữ",
  optionLabelsMultilingual: "Tên tùy chọn đa ngôn ngữ",
  expandAllLangs: "Mở rộng tất cả ngôn ngữ",
  collapseLangs: "Thu gọn theo tab",
  configuredLangs: "Đã cấu hình {{count}} ngôn ngữ",
  manageOptionLangs: "Quản lý nhãn đa ngôn ngữ",
  previewAllTranslations: "Xem tất cả bản dịch",
  saveTranslations: "Lưu bản dịch",
  coreSystemOptionCantDelete: "Tùy chọn cốt lõi của hệ thống, không thể xóa",
