export const navEn = {
  ...
  items: {
    ...
    accounting: "Accounting",
    erpInventoryTrackingGroup: "Tracked Goods",
    erpInventoryTracking: "Vehicles / Finished Goods",
    erpInventoryTrackingParts: "Parts / Components",
    erpInventoryTrackingLot: "Lot",
    erpInventoryTrackingCustom: "Custom",
    hr: "Human Resources",
    hrStaff: "Employees",
    hrDepts: "Departments",
    ...
    erpFinishedGoods: "Finished Goods",
    ...
    vinfastPartsGroup: "Vinfast Parts",
    vinfastPartsDashboard: "Parts Overview",
    vinfastPartsStock: "Parts Stock",
    vinfastPartsStockDesc: "VinFast Parts Stock & Ledger",
    vinfastPartsOtoStock: "Car Parts Stock",
    vinfastPartsOtoStockDesc: "VinFast Parts Stock - Car",
    vinfastPartsXemayStock: "Motorbike Parts Stock",
    vinfastPartsXemayStockDesc: "VinFast Parts Stock - Motorbike",
