...
export const erpInvoicesEn = {
  ...
  tabDetails: "Details",
  tabTransactions: "Object Details",
  ...
  cashTrendTableTitle: "Fluctuation Table by Period",
  positiveNet: "Positive Difference (Out > In)",
  negativeNet: "Negative Difference (In > Out)",
  noChartData: "No partner fluctuation data available",
  partnerProfile: "Partner Profile",

  // Preview Modes & PDF
  viewModeTemplate: "Standard Invoice Preview",
  viewModePdf: "PDF File",
  previewPdfTitle: "Original Invoice PDF",
  previewInvoiceTitle: "Invoice Preview",
  loadingPdf: "Loading PDF...",
  noPdfFileTitle: "No PDF attached",
  noPdfFileDesc:
    "This invoice does not have an original PDF file. You can upload a PDF file in the Attachments tab or view the standard electronic invoice template.",
  switchToTemplate: "Standard Template Preview",
  noPreviewAvailable: "No invoice preview available",
  ...
  actionDetail: "Detail",
  actionPartnerTransactions: "Object Details",
  actionObjectDetails: "Object Details",
  tabGoodsItems: "Goods & Services Details",
  tabGoodsItemsTitle: "Goods & Services Details List",
  tabInvoicesList: "Invoice List",
  tabInvoicesListTitle: "Partner Invoices List",
  partnerObjectDetails: "Object Details",
  itemsCount: "goods/services lines",
  recordsItems: "goods/services lines",
  recordsInvoices: "invoices",
  ...
  invoiceTypeIn: "Input Invoice Category",
  invoiceTypeOut: "Output Invoice Category",
  selectInvoiceType: "-- Select invoice category --",
  invoiceSubcategory: "Invoice Subcategory",
  invoiceSubcategoryIn: "Input Invoice Subcategory",
  invoiceSubcategoryOut: "Output Invoice Subcategory",
  selectInvoiceSubcategory: "-- Select invoice subcategory --",
  selectCategoryFirst: "-- Please select {{categoryLabel}} first --",
  childOf: "Depends on:",
