...
function Btn({ children }: { children: React.ReactNode }) {
  return (
    <button className="px-[14px] py-[7px] rounded-lg border border-border bg-surface text-xs font-medium cursor-pointer text-foreground hover:bg-surface-hover whitespace-nowrap">
      {children}
    </button>
  );
}
