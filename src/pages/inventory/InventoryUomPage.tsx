...
export function InventoryUomPage() {
  ...
  const currentQuery = useInventoryMasterListQuery(uomParams);
  ...
  return (
    <>
      <SpreadsheetPageTemplate<InventoryMasterOption>
        title={t("nav.items.erpInventoryUom") || "Đơn vị tính"}
        desc={t("inventoryMasters.tabs.uomDesc")}
        icon={<Boxes className="h-5 w-5" />}
        tableId="inventory-uom-table"
        items={currentItems}
        columns={columns}
