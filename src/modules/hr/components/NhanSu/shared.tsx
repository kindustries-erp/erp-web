...
export function buildForm(e: Employee): EmpForm {
  return {
    ...
    branch_id:
      typeof (e as Employee & { branch_id?: string | { id?: string } | null })
        .branch_id === "object"
        ? ((e as Employee & { branch_id?: { id?: string } | null }).branch_id
            ?.id ?? "")
        : String(
            (e as Employee & { branch_id?: string | null }).branch_id ?? "",
          ),
  };
}
