...
export function GarageCaseSettlementSection({
  ...
  return (
    <div className="space-y-4 p-3 max-h-[600px] overflow-y-auto">
      {/* ─── 1. BẢNG TIẾN ĐỘ CÔNG NỢ & DÒNG TIỀN (Neutral Business Dual Boards) ─── */}
                ...
                className={cn(
                  ...
                  isOverCollected
                    ...
                    : remainingReceivable === 0 && targetRevenue > 0
                      ? "bg-slate-50 text-emerald-700 border-emerald-300 dark:bg-slate-800 dark:text-emerald-300 dark:border-emerald-800"
                      : "bg-slate-50 text-amber-700 border-amber-300 dark:bg-slate-800 dark:text-amber-300 dark:border-amber-800",
                )}
              >
                {isOverCollected
                ...
                >
                  <div className="space-y-0.5 max-w-[65%]">
                    <div className="flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
                      ...
                      {s.isViaInvoice && (
                        <span className="px-1.5 py-0.2 rounded text-[10px] font-mono font-medium bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
