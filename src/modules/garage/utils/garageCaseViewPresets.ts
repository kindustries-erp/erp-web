...
export const GARAGE_CASE_COLUMN_GROUPS: ColumnGroupDef[] = [
  {
    ...
    columns: [
      ...
      {
        key: "customer",
        labelKey: "cases.columns.customer",
        defaultLabel: "Khách hàng",
        defaultVisible: true,
      },
      {
        key: "classification",
        labelKey: "cases.columns.classificationErp",
        defaultLabel: "Phân loại ERP",
        defaultVisible: true,
      },
      {
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        defaultLabel: "Tổng phải thu",
        defaultVisible: true,
      },
      {
        key: "tienConPhaiThanhToan",
        labelKey: "cases.columns.remainingReceivable",
        defaultLabel: "Còn phải thu",
        defaultVisible: true,
      },
      {
        key: "costProgress",
        labelKey: "cases.columns.costProgress",
        defaultLabel: "Tổng phải trả",
        defaultVisible: true,
      },
      {
        key: "tienConPhaiChi",
