...
import { RotateCcw, Building2, CheckCircle2 } from "lucide-react";
import { money } from "@/shared/utils/format";
import type { MonthlyBreakdownRow } from "../types";

export interface TimeHorizonAgingSectionProps {
  isLoading: boolean;
...
export function TimeHorizonAgingSection({
  isLoading,
  topPartnersBarData,
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center flex-1 text-center py-4 gap-2">
                ...
                <div className="text-xs font-semibold text-foreground">
                  {t("debts:horizonDrawer.settledAll", "Đã tất toán toàn bộ")}
                </div>
                <div className="text-[11px] text-muted-foreground">
                  {t(
                    "debts:horizonDrawer.noDebtInPeriod",
