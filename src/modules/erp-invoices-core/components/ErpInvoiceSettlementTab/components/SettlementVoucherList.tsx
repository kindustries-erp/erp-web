...
export function SettlementVoucherList({
  ...
  if (activeVouchers.length === 0) {
    return (
      <div className="p-3.5 rounded-lg border border-dashed border-slate-200 dark:border-slate-800 text-center text-xs text-slate-400 bg-slate-50/40 dark:bg-slate-900/30">
        {direction === "IN"
          ? t(
              "noSettlementDocsIn",
