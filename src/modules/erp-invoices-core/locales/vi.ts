export const erpInvoicesVi = {
  ...
  cashTrendTableTitle: "Bảng kê biến động theo kỳ",
  positiveNet: "Chênh lệch dương (Bán > Mua)",
  negativeNet: "Chênh lệch âm (Mua > Bán)",
  noChartData: "Chưa có dữ liệu biến động của đối tác",
  partnerProfile: "Hồ sơ đối tác",

  // Preview Modes & PDF
  viewModeTemplate: "Xem trước HĐ thuần",
  viewModePdf: "File PDF",
  previewPdfTitle: "Tệp PDF hóa đơn gốc",
  previewInvoiceTitle: "Xem trước hóa đơn",
  loadingPdf: "Đang tải PDF...",
  noPdfFileTitle: "Chưa có tệp PDF đính kèm",
  noPdfFileDesc:
  ...
  switchToTemplate: "Xem trước HĐ thuần",
  noPreviewAvailable: "Không có bản xem trước hóa đơn",
  ...
  tabGoodsItems: "Chi tiết HHDV",
  tabGoodsItemsTitle: "Danh sách chi tiết hàng hóa & dịch vụ",
  tabInvoicesList: "Chi tiết theo đối tượng",
  tabInvoicesListTitle: "Chi tiết hóa đơn theo đối tượng",
  partnerObjectDetails: "Chi tiết theo đối tượng",
  itemsCount: "dòng HHDV",
  recordsItems: "dòng HHDV",
  recordsInvoices: "hóa đơn",
  ...
  systemAttributes: "Thuộc tính hệ thống",
  customAttributes: "Thuộc tính tùy chỉnh",
  invoiceType: "Phân loại hóa đơn",
  invoiceTypeIn: "Phân loại hóa đơn mua vào",
  invoiceTypeOut: "Phân loại hóa đơn bán ra",
  selectInvoiceType: "-- Chọn phân loại hóa đơn --",
  invoiceSubcategory: "Phân loại chi tiết",
  invoiceSubcategoryIn: "Phân loại chi tiết hóa đơn mua vào",
  invoiceSubcategoryOut: "Phân loại chi tiết hóa đơn bán ra",
  selectInvoiceSubcategory: "-- Chọn phân loại chi tiết hóa đơn --",
  selectCategoryFirst: "-- Vui lòng chọn {{categoryLabel}} trước --",
  childOf: "Phụ thuộc:",
  sellerInfo: "Bên bán",
  buyerInfo: "Bên mua",
