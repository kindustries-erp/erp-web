  ...
  return (
    <>
      ...
      <VoucherTable
        ...
        onAmountMin={(v: string) => handleAmountRangeInput("min", v, () => setPage(1))}
        onAmountMax={(v: string) => handleAmountRangeInput("max", v, () => setPage(1))}
        onStatusFilter={handleStatusFilter}
        counterpartySourceFilter={counterpartySourceFilter}
        onCounterpartySourceFilter={(v: any) => { setCounterpartySourceFilter(v); setPage(1); }}
      />
      <div className="mt-4"><OpeningBalancePanel type="BANK" /></div>
    </>
  );
}
