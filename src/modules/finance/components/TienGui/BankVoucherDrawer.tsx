...
export function BankVoucherDrawer(props: any) {
  ...
  const relatedDocumentsEditable = !!editing && ["APPROVED", "POSTED"].includes(editing.status);
  ...
  return (
    ...
    >
      ...
      <DrawerSection title="Chứng từ liên quan"><RelatedDocumentsEditor value={form.related_documents ?? []} disabled={relatedDocumentsReadOnly} counterpartyId={form.counterparty_id} maxSettlementAmount={Number(form.amount) || undefined} onChange={(value) => setField("related_documents", value)} /></DrawerSection>
