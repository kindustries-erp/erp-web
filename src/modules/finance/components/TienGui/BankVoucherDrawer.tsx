...
export function BankVoucherDrawer(props: any) {
  ...
  return (
    ...
    >
      ...
      <DrawerSection title="Chứng từ liên quan"><RelatedDocumentsEditor value={form.related_documents ?? []} disabled={viewOnly} counterpartyId={form.counterparty_id} maxSettlementAmount={Number(form.amount) || undefined} onChange={(value) => setField("related_documents", value)} /></DrawerSection>
