...
interface PartnerLedgerDrawerProps {
  ...
  setField: <K extends keyof CreatePartnerLedgerItemDto>(
    key: K,
...
export function PartnerLedgerDrawer({
  ...
  return (
    <DrawerModal
      ...
      actions={[
        {
          label: saving ? t("ledger.drawer.saving") : t("ledger.drawer.save"),
          primary: true,
          loading: saving,
          onClick: onSave,
        },
      ...
      <DrawerSection title={t("ledger.drawer.sectionInfo")}>
        ...
        <DrawerField label={t("ledger.drawer.sourceType")}>
          <Combobox
            ...
            onChange={(v) =>
              setField("source_type", v as PartnerLedgerSourceType)
            }
            className="w-full"
            allowClear={false}
          />
        ...
        <DateField
          label={t("ledger.drawer.docDate")}
          value={form.document_date}
          onChange={(v) => setField("document_date", v)}
        />
        <DateField
          label={t("ledger.drawer.postingDate")}
          value={form.posting_date}
          onChange={(v) => setField("posting_date", v)}
        />
        <DateField
          label={t("ledger.drawer.dueDate")}
          value={form.due_date ?? ""}
